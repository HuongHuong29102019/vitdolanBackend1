    ...
    public partial class ItemRepository : IItemRepository
    {
        ...
        public bool Create(ItemModel model)
        {
            ...
            try
            {
                ...
                "@item_material", model.item_material,
                "@item_width", model.item_width,
                "@item_height", model.item_height,
                "@item_depth", model.item_depth);
        ...
        public List<ItemModel> GetDataSameItem()
        {
            ...
            try
            {
                var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_item_same_type");
                if (!string.IsNullOrEmpty(msgError))
                    throw new Exception(msgError);
                return dt.ConvertTo<ItemModel>().ToList();
            }
